...
//		System.out.println(morningRoutine);
		...
		System.out.println("I completed the last element on my list:\n" + morningRoutine.pollLast());
		System.out.println("I completed the first element on my list:\n" + morningRoutine.pollFirst());
